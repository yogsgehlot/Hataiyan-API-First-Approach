...
@section('content')
    <div class="pt-10 flex items-center justify-center overflow-auto">
        <div
            ...
            <h1 class="text-2xl font-semibold text-center text-gray-800 dark:text-gray-100 mb-6">
                Edit Post
            </h1>
            ...
            <form action="{{ route('post.update', $post['id']) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                ...
                {{-- Current Media --}}
                <div>
                    <p class="text-gray-600 dark:text-gray-300 mb-2">Current Media</p>
                    <div class="w-full h-64 bg-gray-200 dark:bg-gray-700 rounded-xl overflow-hidden">
                        @if ($post['media_type'] === 'video')
                            <video src="{{ $post['media_path'] }}" class="w-full h-full object-cover" controls></video>
                        @else
                ...
                {{-- Replace Media --}}
                <div>
                    <p class="text-gray-600 dark:text-gray-300 mb-2">Replace Media (optional)</p>
                    ...
                    <div
                        ...
                        <label for="media" class="flex flex-col items-center justify-center cursor-pointer">
                            ...
                            <span class="text-gray-500 dark:text-gray-300 text-sm md:text-base">
                                Click to upload new photo or video
                            </span>
                ...
                <div>
                    <textarea name="caption" rows="3"
                        ...
                        class="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-3 text-gray-700 dark:text-gray-200 dark:bg-gray-800 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-400 dark:focus:ring-pink-500 transition-colors duration-300 resize-none">{{ $post['caption'] }}</textarea>
                </div>
